...
def supimpose(m1, m0, rg1, rg0):
    ...
    for res in getreses(m1):
        if res.resi in rg1:
            ...
            ats_m1.append(res.getat("C3'"))
            ats_m1.append(res.getat("C4'"))
            ats_m1.append(res.getat("C5'"))
            ats_m1.append(res.getat("O5'"))
            ats_m1.append(res.getat("C2'"))
            ats_m1.append(res.getat("C1'"))
            ats_m1.append(res.getat("O4'"))
            ats_m1.append(res.getat("O2'"))
    ats_m0 = []
    for res in getreses(m0):
        if res.resi in rg0:
            ats_m0.append(res.getat("O3'"))
            ats_m0.append(res.getat("C3'"))
            ats_m0.append(res.getat("C4'"))
            ats_m0.append(res.getat("C5'"))
            ats_m0.append(res.getat("O5'"))
            ats_m0.append(res.getat("C2'"))
            ats_m0.append(res.getat("C1'"))
            ats_m0.append(res.getat("O4'"))
            ats_m0.append(res.getat("O2'"))
